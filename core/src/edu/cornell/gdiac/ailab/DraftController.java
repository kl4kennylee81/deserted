...
public class DraftController {
	...
	public Characters getSelectedChars(){
		...
		Character parent1 = new Character(2000, c1.texture, c1.icon, c1.animation, "Ishaan", 10, 10, Color.BLUE, 0, 0, 0, new Action[]{},0);
		Character parent2 = new Character(2001, c2.texture, c2.icon, c2.animation, "Ishaan", 10, 10, Color.YELLOW, 0, 0, 0, new Action[]{},0);
		int health1 = 0;
