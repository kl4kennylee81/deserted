...
public class RadialSprite implements Drawable {
	...
	public void draw(final SpriteBatch batch, final float x, final float y, float width, float height, final float angle) {
	...
	public void draw(final SpriteBatch batch, final float x, final float y, final float angle) {
